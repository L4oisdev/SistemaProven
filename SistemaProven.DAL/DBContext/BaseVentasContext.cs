...
namespace SistemaProven.DAL.DBContext;

public partial class BaseVentasContext : DbContext
{
    public BaseVentasContext()
    {
    }

    public BaseVentasContext(DbContextOptions<BaseVentasContext> options)
        : base(options)
    {
    }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.IdCategoria).HasName("PK__Categori__8A3D240C4368704E");
        ...
        {
            entity.HasKey(e => e.IdDetalleVenta).HasName("PK__DetalleV__BFE2843FDD0C4F89");
        ...
        {
            entity.HasKey(e => e.IdMenu).HasName("PK__Menu__C26AF48397AF409A");
        ...
        {
            entity.HasKey(e => e.IdNegocio).HasName("PK__Negocio__70E1E107C1C41C2A");
        ...
        {
            entity.HasKey(e => e.IdNumeroCorrelativo).HasName("PK__NumeroCo__25FB547E343701F4");
        ...
        {
            entity.HasKey(e => e.IdProducto).HasName("PK__Producto__07F4A1323E8B5C0E");
        ...
        {
            entity.HasKey(e => e.IdRol).HasName("PK__Rol__3C872F76D3113F8E");
        ...
        {
            entity.HasKey(e => e.IdRolMenu).HasName("PK__RolMenu__CD2045D8D2C3EC28");
        ...
        {
            entity.HasKey(e => e.IdTipoDocumentoVenta).HasName("PK__TipoDocu__A9D59AEE3BD460AF");
        ...
        {
            entity.HasKey(e => e.IdUsuario).HasName("PK__Usuario__645723A617475CA2");
        ...
        {
            entity.HasKey(e => e.IdVenta).HasName("PK__Venta__077D56148A2E950B");
